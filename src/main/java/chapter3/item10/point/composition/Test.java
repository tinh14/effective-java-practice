...
public class Test {
    public static void main(String[] args) {
        ...
        System.out.println("a equals b: " + a1.equals(b1.asPoint()));
        System.out.println("b equals a: " + b1.asPoint().equals(a1));
        System.out.println("Logic check: ");
        System.out.println("a equals b: " + a2.asPoint().equals(b2));
        System.out.println("b equals c: " + b2.equals(c2.asPoint()));
        System.out.println("a equals c: " + a2.asPoint().equals(c2.asPoint()));

        // Liskov substitution principal check
        Point p = new Point(1,  0);
        Point cp = new CounterPoint(1,  0);
        SmellPoint sp = new SmellPoint(1, 0, "stinky");
        ...
        System.out.println("SmellPoint instance: " + UnitCircleChecker.onUnitCircle(sp.asPoint()));
        System.out.println();
